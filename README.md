...
--> States closer to the goal have higher values, as they have a greater probability of reaching the goal and
     receiving a reward.
--> States near holes or dead ends have lower values, since following the policy from these states is more likely
     to terminate without obtaining a reward.
